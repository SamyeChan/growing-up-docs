...
[掘金 | 刘小夕Step-By-Step项目（周刊01）](https://juejin.im/post/5cea6e5fe51d45775e33f4de#heading-0)

---

HTML5的语义化：合理正确的使用语义化的标签来创建页面结构，从而在标签上即可直观的知道这个标签的作用，而非滥用div。

## 语义化优点

- 代码结构清晰，易阅读易开发易维护；
- 方便其他设备（如屏幕阅读器）根据语义渲染页面；
- 利于SEO → 搜索引擎爬虫会根据不同标签赋予不同权重；
